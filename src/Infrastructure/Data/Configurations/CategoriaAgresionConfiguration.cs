...
public class CategoriaAgresionConfiguration : IEntityTypeConfiguration<CategoriaAgresion>
{
    public void Configure(EntityTypeBuilder<CategoriaAgresion> builder)
    {
